...
- [x] **LNG-01**: Library installs and runs on CPython 3.11, 3.12, 3.13, 3.14 on Linux x86_64 / aarch64 and Windows x86_64 (strong guarantee — CI mandatory matrix)
- [x] **LNG-02**: Library installs on macOS arm64 + Python 3.13+; runtime operation is observed but not guaranteed in v0.2.0 (CI continue-on-error; full guarantee deferred to v0.3.0)
