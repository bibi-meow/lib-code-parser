...
<required_reading>
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude
                  → checks C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done
                  → writes to C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/hooks/
...
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/common-bug-patterns.md
