...
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
