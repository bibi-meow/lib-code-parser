...
The keys live in `.claude/settings.json` (project) or `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/settings.json` (global) — **not** in `.planning/config.json`:
