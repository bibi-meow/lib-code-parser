...
<template>
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/workflows/diagnose-issues.md
