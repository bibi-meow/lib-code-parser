...
INSTALL_JS_GLOBAL="C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
