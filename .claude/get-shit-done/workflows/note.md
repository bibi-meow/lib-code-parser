...
- **Global scope**: `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/notes/`)
...
2. Glob `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/notes/` — works in any directory
