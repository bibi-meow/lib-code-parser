...
```
Agent(
  prompt="Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/templates/SECURITY.md`
