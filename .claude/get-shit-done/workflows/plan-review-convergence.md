...
```bash
INIT=$(node "C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
