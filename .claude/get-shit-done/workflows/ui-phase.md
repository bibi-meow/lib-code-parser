...
```markdown
Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-ui-checker.md for instructions.
