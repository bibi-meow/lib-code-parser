...
<required_reading>
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/ai-frameworks.md
@C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents/gsd-eval-planner.md for instructions.
