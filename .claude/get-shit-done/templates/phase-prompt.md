...
<!-- For checkpoint task examples and patterns, see @C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
