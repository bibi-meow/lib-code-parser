...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/commands/gsd
AGENTS_DIR=C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/agents
```
...
<execution_context>
Surface state file: `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/skills/.gsd-profile`
Engine module: `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/work/agent_company/spec-reviewer-libs/lib-code-parser/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
